...
const CONTENT: Record<string, Content> = {
  pt: {
    ...
    contactIntro: 'Não mordemos. A menos que você venha com promessa de retorno garantido.',
  ...
  en: {
    ...
    contactIntro: 'We don\'t bite. Unless you come with guaranteed return promises.',
    contactName: 'Ricardina Cifrão',
  ...
  es: {
    ...
    contactIntro: 'No mordemos. A menos que vengas con promesas de retorno garantizado.',
    contactName: 'Ricardina Cifrão',
